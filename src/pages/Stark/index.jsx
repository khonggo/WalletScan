    ...
    const handleOk = async () => {
        try {
            ...
            if (index !== -1) {
                ...
                getStarkFee(values.address).then(({total_fee}) => {
                    updatedData[index] = {
                        ...updatedData[index],
                        total_fee: total_fee
                    };
        ...
        try {
            ...
            for (let address of addresses) {
                ...
                if (index !== -1) {
                    ...
                    getStarkFee(address).then(({total_fee}) => {
                        updatedData[index] = {
                            ...updatedData[index],
                            total_fee: total_fee,
                        };
        ...
        try {
            ...
            for (let key of selectedKeys) {
                ...
                if (index !== -1) {
                    ...
                    promises.push(getStarkFee(item.address).then(({total_fee}) => {
                    ...
                    <Table
                        ...
                        summary={pageData => {
                            ...
                            pageData.forEach(({
                                ...
                                ethBalance += Number(stark_eth_balance);
                            })
                            ...
                            return (
                                <>
                                    <Table.Summary.Row>
                                        ...
                                        <Table.Summary.Cell index={6}>{ethBalance.toFixed(4)}</Table.Summary.Cell>
                                        {emptyCells}
                                    </Table.Summary.Row>
                                </>
                            )
